...
analyze_model <- function(model){
  ...
  # Append the new row 
  new_row <- data.frame(model=model_call_str, t=resid_statistic, errors_zero_is_pass, bp=bp_statistic, constant_variance_is_pass=constant_variance_is_pass,  R2=r2_value, LOOR2=loor2_value, dffits_filtered=dffits_str, dfbetas_filtered=dfbetas_str)
...
errors of the regression coeﬀicients. How do these compare in magnitude to the standard
...
There does not appear to be evidence that the model is overfit. Especially since

• Revisit the output of autoplot to check for any highly influential points. If you find
